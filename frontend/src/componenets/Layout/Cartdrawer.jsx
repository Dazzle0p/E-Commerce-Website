...
const Cartdrawer = ({openDrawer, toggleCartDrawer}) => {
  ...
  return (
    <div
      className={
        `fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-[30rem]  h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col z-50 ${ openDrawer ? "translate-x-0": "translate-x-full" }`
      }
    >
        {/* Close Cart Button */}
      ...
      <div className="flex-grow p-4 overflow-y-auto">
        <h2 className="text-xl font-semibold  py-1 border-b border-gray-200 text-center">Your Cart</h2>
